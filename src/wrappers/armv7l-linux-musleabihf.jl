# Autogenerated wrapper script for libsndfile_jll for armv7l-linux-musleabihf
export sndfile_concat, sndfile_metadata_get, sndfile_cmp, sndfile_salvage, sndfile_info, sndfile_deinterleave, sndfile_interleave, sndfile_play, sndfile_metadata_set, sndfile_convert, libsndfile
...
"""
function __init__()
    global artifact_dir = abspath(artifact"libsndfile")
    ...
    foreach(p -> append!(PATH_list, p), (FLAC_jll.PATH_list, Ogg_jll.PATH_list, libvorbis_jll.PATH_list,))
    foreach(p -> append!(LIBPATH_list, p), (FLAC_jll.LIBPATH_list, Ogg_jll.LIBPATH_list, libvorbis_jll.LIBPATH_list,))

    global sndfile_concat_path = normpath(joinpath(artifact_dir, sndfile_concat_splitpath...))

    push!(PATH_list, dirname(sndfile_concat_path))
    global sndfile_metadata_get_path = normpath(joinpath(artifact_dir, sndfile_metadata_get_splitpath...))

    push!(PATH_list, dirname(sndfile_metadata_get_path))
    global sndfile_cmp_path = normpath(joinpath(artifact_dir, sndfile_cmp_splitpath...))

    push!(PATH_list, dirname(sndfile_cmp_path))
    global sndfile_salvage_path = normpath(joinpath(artifact_dir, sndfile_salvage_splitpath...))

    push!(PATH_list, dirname(sndfile_salvage_path))
    global sndfile_info_path = normpath(joinpath(artifact_dir, sndfile_info_splitpath...))

    push!(PATH_list, dirname(sndfile_info_path))
    global sndfile_deinterleave_path = normpath(joinpath(artifact_dir, sndfile_deinterleave_splitpath...))

    push!(PATH_list, dirname(sndfile_deinterleave_path))
    global sndfile_interleave_path = normpath(joinpath(artifact_dir, sndfile_interleave_splitpath...))

    push!(PATH_list, dirname(sndfile_interleave_path))
    global sndfile_play_path = normpath(joinpath(artifact_dir, sndfile_play_splitpath...))

    push!(PATH_list, dirname(sndfile_play_path))
    global sndfile_metadata_set_path = normpath(joinpath(artifact_dir, sndfile_metadata_set_splitpath...))

    push!(PATH_list, dirname(sndfile_metadata_set_path))
    global sndfile_convert_path = normpath(joinpath(artifact_dir, sndfile_convert_splitpath...))

    push!(PATH_list, dirname(sndfile_convert_path))
    global libsndfile_path = normpath(joinpath(artifact_dir, libsndfile_splitpath...))
